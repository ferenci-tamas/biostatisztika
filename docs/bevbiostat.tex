...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{birthwt}\SpecialCharTok{$}\NormalTok{bwt}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{birthwt}\SpecialCharTok{$}\NormalTok{race }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{race, }\AttributeTok{levels =} \DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{, }\AttributeTok{labels =} \FunctionTok{c}\NormalTok{( }\StringTok{"Kaukázusi"}\NormalTok{, }\StringTok{"Afroamerikai"}\NormalTok{, }\StringTok{"Egyéb"}\NormalTok{ ) )}
\FunctionTok{table}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{race )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prop.table}\NormalTok{( }\FunctionTok{table}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{race ) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cbind}\NormalTok{( }\FunctionTok{table}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{race ), }\FunctionTok{prop.table}\NormalTok{( }\FunctionTok{table}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{race ) ) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{barplot}\NormalTok{( }\FunctionTok{table}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{race ), }\AttributeTok{xlab =} \StringTok{"Rassz"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Gyakoriság [fő]"}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tab }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{( }\FunctionTok{cut}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{bwt, }\FunctionTok{seq}\NormalTok{( }\DecValTok{500}\NormalTok{, }\DecValTok{5000}\NormalTok{, }\DecValTok{500}\NormalTok{ ) ) )}
\FunctionTok{cbind}\NormalTok{( }\AttributeTok{Ci0 =} \FunctionTok{seq}\NormalTok{( }\DecValTok{500}\NormalTok{, }\DecValTok{4500}\NormalTok{, }\DecValTok{500}\NormalTok{ ), }\AttributeTok{Ci1 =} \FunctionTok{seq}\NormalTok{( }\DecValTok{1000}\NormalTok{, }\DecValTok{5000}\NormalTok{, }\DecValTok{500}\NormalTok{ ), }\AttributeTok{fi =}\NormalTok{ tab, }\AttributeTok{gi =} \FunctionTok{prop.table}\NormalTok{( tab ) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{hist}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{bwt, }\AttributeTok{xlab =} \StringTok{"Születési tömeg [g]"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Gyakoriság [fő]"}\NormalTok{, }\AttributeTok{main =} \StringTok{""}\NormalTok{ )}
\FunctionTok{rug}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{bwt )}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{hist}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{bwt, }\DecValTok{3}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"Születési tömeg [g]"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Gyakoriság"}\NormalTok{, }\AttributeTok{main =} \StringTok{""}\NormalTok{ )}
\FunctionTok{hist}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{bwt, }\AttributeTok{xlab =} \StringTok{"Születési tömeg [g]"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Gyakoriság"}\NormalTok{, }\AttributeTok{main =} \StringTok{""}\NormalTok{ )}
\FunctionTok{hist}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{bwt, }\DecValTok{30}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"Születési tömeg [g]"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Gyakoriság"}\NormalTok{, }\AttributeTok{main =} \StringTok{""}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{( }\FunctionTok{density}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{bwt ), }\AttributeTok{xlab =} \StringTok{"Születési tömeg [g]"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Sűrűség"}\NormalTok{, }\AttributeTok{main =} \StringTok{""}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{boxplot}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{bwt )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{race, birthwt}\SpecialCharTok{$}\NormalTok{ui )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tab }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{race, birthwt}\SpecialCharTok{$}\NormalTok{ui )}
\FunctionTok{rbind}\NormalTok{( }\FunctionTok{cbind}\NormalTok{( tab, }\FunctionTok{margin.table}\NormalTok{( tab, }\DecValTok{1}\NormalTok{ ) ), }\FunctionTok{cbind}\NormalTok{( }\FunctionTok{t}\NormalTok{( }\FunctionTok{margin.table}\NormalTok{( tab, }\DecValTok{2}\NormalTok{ ) ), }\FunctionTok{margin.table}\NormalTok{( tab ) ) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tab }\OtherTok{\textless{}{-}} \FunctionTok{prop.table}\NormalTok{( }\FunctionTok{table}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{race, birthwt}\SpecialCharTok{$}\NormalTok{ui ) )}
\FunctionTok{rbind}\NormalTok{( }\FunctionTok{cbind}\NormalTok{( tab, }\FunctionTok{margin.table}\NormalTok{( tab, }\DecValTok{1}\NormalTok{ ) ), }\FunctionTok{cbind}\NormalTok{( }\FunctionTok{t}\NormalTok{( }\FunctionTok{margin.table}\NormalTok{( tab, }\DecValTok{2}\NormalTok{ ) ), }\FunctionTok{margin.table}\NormalTok{( tab ) ) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tab }\OtherTok{\textless{}{-}} \FunctionTok{prop.table}\NormalTok{( }\FunctionTok{table}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{race, birthwt}\SpecialCharTok{$}\NormalTok{ui ), }\DecValTok{1}\NormalTok{ )}
\FunctionTok{rbind}\NormalTok{( }\FunctionTok{cbind}\NormalTok{( tab, }\FunctionTok{margin.table}\NormalTok{( tab, }\DecValTok{1}\NormalTok{ ) ) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tab }\OtherTok{\textless{}{-}} \FunctionTok{prop.table}\NormalTok{( }\FunctionTok{table}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{race, birthwt}\SpecialCharTok{$}\NormalTok{ui ), }\DecValTok{2}\NormalTok{ )}
\FunctionTok{rbind}\NormalTok{( tab, }\FunctionTok{t}\NormalTok{( }\FunctionTok{margin.table}\NormalTok{( tab, }\DecValTok{2}\NormalTok{ ) ) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{( bwt }\SpecialCharTok{\textasciitilde{}}\NormalTok{ lwt, }\AttributeTok{data =}\NormalTok{ birthwt, }\AttributeTok{xlab =} \StringTok{"Anya testtömege (UM) [font]"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Születési tömeg [g]"}\NormalTok{ )}
\FunctionTok{abline}\NormalTok{( }\AttributeTok{h =} \FunctionTok{mean}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{bwt ), }\AttributeTok{v =} \FunctionTok{mean}\NormalTok{( birthwt}\SpecialCharTok{$}\NormalTok{lwt ), }\AttributeTok{lty =} \StringTok{"dashed"}\NormalTok{ )}
\FunctionTok{abline}\NormalTok{( }\FunctionTok{lm}\NormalTok{( bwt }\SpecialCharTok{\textasciitilde{}}\NormalTok{ lwt, }\AttributeTok{data =}\NormalTok{ birthwt ), }\AttributeTok{lty =} \StringTok{"dotted"}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
##  [1] 69.63484 71.15811 69.74722 71.49614 71.16509 70.33008 69.72829 72.20135
##  [9] 70.31785 68.25791
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res }\OtherTok{\textless{}{-}} \FunctionTok{replicate}\NormalTok{( }\DecValTok{100000}\NormalTok{, }\FunctionTok{mean}\NormalTok{( }\FunctionTok{rnorm}\NormalTok{( }\DecValTok{30}\NormalTok{, }\DecValTok{70}\NormalTok{, }\DecValTok{10}\NormalTok{ ) ) )}
...
\NormalTok{res50 }\OtherTok{\textless{}{-}} \FunctionTok{replicate}\NormalTok{( }\DecValTok{100000}\NormalTok{, }\FunctionTok{mean}\NormalTok{( }\FunctionTok{rnorm}\NormalTok{( }\DecValTok{50}\NormalTok{, }\DecValTok{70}\NormalTok{, }\DecValTok{10}\NormalTok{ ) ) )}
\FunctionTok{lines}\NormalTok{( }\FunctionTok{density}\NormalTok{( res50 ), }\AttributeTok{col =} \StringTok{"blue"}\NormalTok{ )}
\NormalTok{res300 }\OtherTok{\textless{}{-}} \FunctionTok{replicate}\NormalTok{( }\DecValTok{100000}\NormalTok{, }\FunctionTok{mean}\NormalTok{( }\FunctionTok{rnorm}\NormalTok{( }\DecValTok{300}\NormalTok{, }\DecValTok{70}\NormalTok{, }\DecValTok{10}\NormalTok{ ) ) )}
...
Ez tehát azt jelenti, hogy a 2944.5873016 gramm nem csak a születési tömegek átlaga (ahogy azt az előbb mondtuk), hanem egyúttal a ,,vizsgálat beválogatási feltételeinek megfelelő újszülöttek'\,' (fiktív, végtelen!) sokaságának várható értékének becslője is! Nem csak azt mondhatjuk, hogy 2944.5873016 gramm a mintaátlag (biztosan), hanem azt is, hogy ez a legjobb tippünk arra, hogy mennyi a sokaság várható értéke. Vegyük észre, hogy minket valójában ez utóbbi érdekel! Tehát bár a számérték itt pont ugyanaz lett (ez nincs mindig így!), az igazán érdekes eredmény az utóbbi megfogalmazás (hiszen minket nem \emph{konkrétan} ez a 189 újszülött érdekel, hanem \emph{általában} az ilyen újszülöttek jellemzőinek viselkedése).
...
A születési tömegek 95\%-os konfidenciaintervalluma {[}2840,0--3049,2{]} gramm. (Megjegyezzük, hogy ez a fentitől kissé eltérő módszerrel készült, ami tekintettel van arra is, hogy itt most -- szemben a fenti példával -- nem ismerjük \emph{a priori} a sokaság szórását.) Ez azt jelenti, hogy a \emph{legjobb} tippünk a születési tömeg sokasági várható értékére a 2944.5873016 gramm, de azt is tudjuk ezen felül mondani, hogy bár ez csak bizonytalan tipp (hiszen a becsült érték mintáról-mintára ingadozik), de 95\%-os \emph{megbízhatósággal} azért kijelenthető, hogy nem kisebb a keresett, ismeretlen sokasági várható érték mint 2840,0 gramm és nem nagyobb mint 3049,2 gramm. (Amit úgy értünk, hogy azt becsüljük, hogy ha a sokaságból 100 mintát vennénk, és mindegyikből ugyanígy megkonstruálnánk a konfidenciaintervallumokat, akkor várhatóan 95 esetben tartalmazná a CI a valódi, sokasági értéket.) Érdemes megfigyelni, hogy a konfidenciaintervallum két végpontja szimmetrikus a pontbecslésre; ez a várható érték becslésére jellemző, de más paramétereknél nem feltétlenül van így.

Itt is hasznos mindezeket egy szimulációval szemléltetni (\ref{fig:cisim}. ábra).

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SimData }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{( }\AttributeTok{idx =} \DecValTok{1}\SpecialCharTok{:}\DecValTok{100}\NormalTok{, }\AttributeTok{CI =} \FunctionTok{t}\NormalTok{( }\FunctionTok{replicate}\NormalTok{( }\DecValTok{100}\NormalTok{, TeachingDemos}\SpecialCharTok{::}\FunctionTok{z.test}\NormalTok{( }\FunctionTok{rnorm}\NormalTok{( }\DecValTok{30}\NormalTok{, }\DecValTok{70}\NormalTok{, }\DecValTok{10}\NormalTok{ ), }\AttributeTok{stdev =} \DecValTok{10}\NormalTok{ )}\SpecialCharTok{$}\NormalTok{conf.int ) ) )}
\NormalTok{Hmisc}\SpecialCharTok{::}\FunctionTok{Dotplot}\NormalTok{( idx }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Hmisc}\SpecialCharTok{::}\FunctionTok{Cbind}\NormalTok{( }\ConstantTok{NA}\NormalTok{, CI}\FloatTok{.1}\NormalTok{, CI}\FloatTok{.2}\NormalTok{ ), }\AttributeTok{data =}\NormalTok{ SimData, }\AttributeTok{abline =} \FunctionTok{list}\NormalTok{( }\AttributeTok{v =} \DecValTok{70}\NormalTok{, }\AttributeTok{col =} \StringTok{"red"}\NormalTok{, }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{ ), }\AttributeTok{ylab =} \StringTok{""}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}
